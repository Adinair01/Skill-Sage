...
export default function RecommendationsSection() {
  ...
  return (
    <section id="recommendations" className="bg-gradient-to-br from-cream-50 to-brown-50 py-12 sm:py-16 lg:py-20" data-testid="recommendations-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-text-primary mb-3 sm:mb-4 font-serif">Personalized Recommendations</h2>
          <p className="text-base sm:text-lg lg:text-xl text-text-secondary px-4">AI-curated career paths and learning opportunities just for you</p>
        </div>

        {/* Career Paths */}
        <div className="mb-12 sm:mb-16">
          <h3 className="text-xl sm:text-2xl font-bold text-text-primary mb-6 sm:mb-8 font-serif">Recommended Career Paths</h3>
        ...
        <div className="mb-12 sm:mb-16">
          <h3 className="text-xl sm:text-2xl font-bold text-text-primary mb-6 sm:mb-8 font-serif">Recommended Courses</h3>
        ...
        <div>
          <h3 className="text-xl sm:text-2xl font-bold text-text-primary mb-6 sm:mb-8 font-serif">Internship Opportunities</h3>
