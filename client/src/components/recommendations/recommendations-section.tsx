...
export default function RecommendationsSection() {
  ...
  return (
    <section id="recommendations" className="bg-gradient-to-br from-gray-50 to-blue-50 py-20" data-testid="recommendations-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Personalized Recommendations</h2>
          <p className="text-xl text-gray-600">AI-curated career paths and learning opportunities just for you</p>
        </div>

        {/* Career Paths */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-gray-900 mb-8">Recommended Career Paths</h3>
        ...
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-gray-900 mb-8">Recommended Courses</h3>
        ...
        <div>
          <h3 className="text-2xl font-bold text-gray-900 mb-8">Internship Opportunities</h3>
